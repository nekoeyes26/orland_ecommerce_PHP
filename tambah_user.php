...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Tambah Akun Orland</title>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner" style="padding-top: 60px; padding-bottom: 60px;">
						<h3>Tambah Akun</h3>
						<form class="row login_form" action="config/tambah_akun.php" method="post">
                            ...
                            <div class="col-md-12 form-group">
                                <select name="akses_id" required class="nice-select shipping_select">
                                    <option value="--">Pilih Akses ID</option>
