			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<p>Jangan sampai kelewatan promo promo menarik, ayo daftar sekarang!</p>
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="config/validasi_login.php" method="post">
